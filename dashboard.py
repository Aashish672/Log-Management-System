...
# --- 5. TEMPLATE & BLOCK VIEWER (Column 2) ---
with col2:
    ...
    if not templates:
        ...
        # --- Template Selector ---
        st.subheader("Discovered Log Templates")
        ...
        st.subheader("Compressed Log Block Viewer")
        
        # Create a mapping of readable string to template_id
        template_options = {
            f"{t['template']} (Count: {t.get('count', 0)})": str(t['_id'])
            for t in templates
        }
